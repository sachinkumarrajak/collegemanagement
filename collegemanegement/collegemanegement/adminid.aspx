<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminid.aspx.cs" Inherits="collegemanegement.gallery" %>
      ...
      /  LOGIN
        ...
        <div id="form">
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">Enter Super User ID:-</td>
                    <td class="auto-style3">
                        &nbsp;</td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" BorderColor="Red" ControlToValidate="TextBox1" ErrorMessage="Please enter user id" ForeColor="Red"></asp:RequiredFieldValidator>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style2">
                        <br />
                        Enter Root Password:-</td>
                    <td class="auto-style3">
                        &nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter Password"  Width="273px" Height="25px" style="top: 33px; left: 375px; position: absolute" TextMode="Password"></asp:TextBox>
                        &nbsp;</td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Label ID="Label1" runat="server" style="top: 70px; left: 566px; position: absolute; height: 19px; width: 217px" Text="sorry wrong password"></asp:Label>
                ...
                <tr>
                    <td class="auto-style2">
                        &nbsp;</td>
                    <td class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button1" runat="server" BackColor="#1A1F33" ForeColor="White" style="top: 68px; left: 431px; position: absolute; height: 27px" Text="LOGIN" Width="93px" OnClick="Button1_Click" />
                        &nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter user id"  Width="273px" Height="25px" style="top: 88px; left: 374px; position: absolute"></asp:TextBox>
        </div>
    </form>
</body>
</html>
