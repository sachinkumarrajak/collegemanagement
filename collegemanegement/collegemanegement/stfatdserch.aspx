<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stfatdserch.aspx.cs" Inherits="collegemanegement.stfatdserch" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>stfadserch</title>
     <style>
         *
        {
            margin:0px;
  ...
  <div id="right111">
    ...
    <div id="form">
        <table class="auto-style3">
            <tr>
                <td class="auto-style5" style="font-weight: 700; text-align: right">DATE:</td>
                <td>
                    <asp:TextBox ID="txtdate" runat="server" Height="25px" Width="302px"></asp:TextBox>
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/JColorChooser.gif" OnClick="ImageButton1_Click1" style="top: -3px; left: 626px; position: absolute; height: 32px; width: 32px" />
                </td>
                <td class="auto-style4">
                    <asp:Button ID="Button1" runat="server" BackColor="#1A1F33" ForeColor="White" OnClick="Button1_Click" Text="SEARCH" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" style="top: 85px; left: 77px; position: absolute; height: 114px; width: 205px">
