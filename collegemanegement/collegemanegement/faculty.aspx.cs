    ...
    public partial class faculty : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new OdbcCommand("insert into faculty values(?,?,?,?,?,?,?,?,?,?,?,?,?)", cn);
                ...
                cmd = new OdbcCommand("SELECT id from faculty order by id", cn);
                ...
                lblsave.Text = "Faculty id is" + regno;
            ...
            {
                lblinfo.Text = "subjet is not avilable";
            }
            finally
            {
                cn.Close();
