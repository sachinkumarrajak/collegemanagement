<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feework.aspx.cs" Inherits="collegemanegement.feework" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>fee work</title>
     <style>
         *
        {
            margin:0px;
...
<div id="right11">
  ...
  <div id="right111">
    ...
    <div id="nav1">
            <ul>
                <li><a href="fee.aspx">TAKE</a></li>
                <!-- <li><a href="loginfee.aspx">CHECK</a></li>-->
                <li><a href="feecheck.aspx">SEARCH</a></li>
