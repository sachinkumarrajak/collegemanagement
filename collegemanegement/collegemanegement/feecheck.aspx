<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feecheck.aspx.cs" Inherits="collegemanegement.feecheck" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>feecheck</title>
     <style>
         *
        {
            margin:0px;
  ...
  <div id="right112">
      <p id="asa">a</p>
        ...
        <table class="auto-style1">
            <hr >
            <tr>
                <td class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Enter Amount&nbsp;Due:-</b></td>
                <td class="auto-style4">
                    <asp:TextBox ID="TextBox1" runat="server" Height="26px" Width="223px" style="top: 1px; left: 411px; position: absolute"></asp:TextBox>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" ForeColor="White" OnClick="Button1_Click" Text="CHECK" BackColor="#1A1F33" style="top: 2px; left: 736px; position: absolute; height: 26px; width: 67px" />
                    &nbsp;</td>
            </tr>
            <hr />
            <tr>
            ...
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td class="auto-style4">
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" Height="204px" Width="281px">
