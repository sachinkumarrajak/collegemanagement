<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginfee.aspx.cs" Inherits="collegemanegement.loginfee" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>loginfee</title>
      <style>
         *
        {
            margin:0px;
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="userid" Height="22px" Width="236px"></asp:TextBox>
                    </td>
                    <td class="auto-style4">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Enter your user id" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style5">PASSWORD:-</td>
                    <td class="auto-style8">
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="password" Height="20px" Width="236px" TextMode="Password"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style9">
                        <asp:Button ID="Button1" runat="server" BackColor="#1A1F33" ForeColor="White" Height="31px" OnClick="Button1_Click" Text="LOGIN" Width="118px" />
&nbsp;&nbsp;&nbsp; </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
