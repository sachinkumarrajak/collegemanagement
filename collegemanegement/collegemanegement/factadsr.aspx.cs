...
{  
    public partial class factadsr : System.Web.UI.Page
    {
        OdbcConnection cn;
        OdbcCommand cmd;
        OdbcDataReader dr;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                string qry = "select s.id,s.name,s.dept,mk.statues from faculty s,facultyatd mk where s.id=mk.facid and mk.dates='" + txtdate.Text + "'";
