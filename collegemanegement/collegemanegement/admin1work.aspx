<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin1work.aspx.cs" Inherits="collegemanegement.admin1work" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>adminwork1</title>
    <style>
         *
        {
            margin:0px;
  ...
  <div id="right111">
    ...
    <form id="form1" runat="server">
        <div id="form">
            ...
            <asp:Label ID="lbl2" runat="server" style="top: -102px; left: 453px; position: absolute; height: 19px; width: 340px; font-weight: 700; color: #FF0000"></asp:Label>
     
</div>
        <div id="nav1">
            <ul>
                <li><a href="addmission.aspx">ADMISSION</a></li>
                 <li><a href="loginfee.aspx">FEE</a></li>
                <li><a href="attandancework.aspx">ATTENDANCE</a></li>
                    <li><a href="resultwork.aspx">RESULT</a></li>
                <li><a href="facultywork.aspx">FACULTIES</a></li>
                <li><a href="staffwork.aspx">STAFF</a></li>
                <li><a href="subject.aspx">SUBJECT</a></li>

                <li><a href="adminid.aspx">LOGOUT</a></li>
