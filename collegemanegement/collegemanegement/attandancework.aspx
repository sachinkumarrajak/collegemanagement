<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attandancework.aspx.cs" Inherits="collegemanegement.attandancework" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Attandancework</title>
     <style>
         *
        {
            margin:0px;
...
<div id="right11">
  ...
  <div id="right111">
    ...
    <div id="nav1">
            <ul>
                <li><a href="studatd.aspx">STUDENT</a></li>
                 <li><a href="facatd.aspx">FACULTY</a></li>
                <li><a href="stfatd.aspx">STAFF</a></li>
