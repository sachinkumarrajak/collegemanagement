<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="facultywork.aspx.cs" Inherits="collegemanegement.facultywork" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>facultywork</title>
     <style>
         *
        {
            margin:0px;
...
<div id="right11">
  ...
  <div id="right111">
    ...
    <div id="nav1">
            <ul>
                <li><a href="faculty.aspx">ADD</a></li>
                 <li><a href="facultyupdate.aspx">UPDATE</a></li>
                <li><a href="facsrch.aspx">SEARCH</a></li>
