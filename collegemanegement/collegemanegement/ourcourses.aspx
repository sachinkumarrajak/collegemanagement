<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ourcourses.aspx.cs" Inherits="collegemanegement.ourcourses" %>
    ...
    <div id="head">
        ...
        <div id="nav">
          ...
          <ul id="menu">
            ...
            <li><a class="active2" href="#">Enquery</a>
              <ul>
                <li><a class="active2" href="#">our courses</a></li>
            ...
            <li><a class="active1"href="admin.aspx">ADMIN</a> </li>
