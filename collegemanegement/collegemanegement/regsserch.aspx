<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="regsserch.aspx.cs" Inherits="collegemanegement.regsserch" %>
        ...
        <div id="nav">
          ...
          <ul id="menu">
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">ID:-<asp:TextBox ID="TextBox1" runat="server" Width="185px"></asp:TextBox>
                    </td>
                    <td class="auto-style3">--or--</td>
                    <td class="auto-style4">NAME :-<asp:TextBox ID="TextBox2" runat="server" Width="165px"></asp:TextBox>
                    </td>
                    <td>&nbsp;&nbsp;
                        <asp:Button ID="SERCH" runat="server" Text="SERCH" Width="67px" />
                        &nbsp;</td>
                </tr>
                <tr>
