<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resultserch.aspx.cs" Inherits="collegemanegement.resultserch" %>
  ...
  <div id="right111">
    ...
    <div id="form">
        <table class="auto-style1">
            <tr>
                <td class="auto-style3">ENTER ROLL NUMBER:-</td>
                <td class="auto-style5">
                    <asp:TextBox ID="TextBox1" runat="server" Height="24px" Width="164px"></asp:TextBox>
                </td>
                <td class="auto-style6">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Enter roll" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>SELECT SEMESTER:-</b>&nbsp;</td>
                <td class="auto-style8">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="35px" Width="161px">
                ...
                <td class="auto-style9">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList1" ErrorMessage="Select semester" ForeColor="Red" InitialValue="--select semester--"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="lblinfo111" runat="server"></asp:Label>
                    &nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td class="auto-style4">
                    <asp:Button ID="Button1" runat="server" BackColor="#FF0066" ForeColor="White" OnClick="Button1_Click" style="height: 26px" Text="SERCH" Width="165px" />
                </td>
                <td>
                    <asp:Label ID="lblinfo101" runat="server" style="top: 118px; left: 617px; position: absolute; height: 19px; width: 107px; right: 372px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
