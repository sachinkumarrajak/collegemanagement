...
{
    public partial class facultyatandance : System.Web.UI.Page
    {
        OdbcConnection cn;
        OdbcCommand cmd;
        OdbcDataReader dr;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                cmd = new OdbcCommand("insert into facultyatd values(?,?,?)", cn);
                cmd.Parameters.AddWithValue("@aid", TextBox2.Text);
