...
{
    public partial class stfatdserch : System.Web.UI.Page
    {
        OdbcConnection cn;
        OdbcCommand cmd;
        OdbcDataReader dr;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                string qry = "select s.id,s.name,mk.statues from staf s,stafattan mk where s.id=mk.stafid and mk.dates='" + txtdate.Text + "'";
