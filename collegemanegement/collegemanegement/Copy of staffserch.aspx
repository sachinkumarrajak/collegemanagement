<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staffserch.aspx.cs" Inherits="collegemanegement.staffserch" %>
...
<div id="right12">
  ...
  <div id="right112">
    ...
    <div style="top: 350px; left: 125px; position: absolute; height: 23px; width: 1152px">
        ...
        <asp:Button ID="Button1" runat="server" BackColor="#1A1F33" ForeColor="White" style="top: -5px; left: 903px; position: absolute; height: 26px; width: 74px" Text="SERCH" />
